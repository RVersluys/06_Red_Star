        ...
        if levelnumber == 0:
          ...
          #  self.textlist.append([220, "And don't get killed", 30, (0, 150, 0), (100, 40), (warscreenwidth / 2, 100), (500, 50)])
           # self.textlist.append([380, "Now com'an, chop chop...", 30, (0, 150, 0), (100, 40), (warscreenwidth / 2, 100), (500, 50)])
            ...
            self.spawnlist.append([700, 9, 400, 0, 0, 4, [(0,0)], [(60,1,0)],0])
            self.spawnlist.append([760, 9, 800, 0, 0, 4, [(0, 0)], [(60, 1, 0)], 0])
            self.spawnlist.append([820, 9, 1200, 0, 0, 4, [(0, 0)], [(60, 1, 0)], 200])

            # 1100 ticks: derde aanval: fighters (driveby shooting, aimed)
            self.spawnlist.append([1100, 9, 0, 0, 3, 3, [(0,0)], [(100,1,0)],0])
            self.spawnlist.append([1160, 9, 1440, 0, -3, 3, [(0,0)], [(100,1,0)],200])
            self.spawnlist.append([1220, 9, 200, 0, 3, 3, [(0,0)], [(100,1,0)],0])
            self.spawnlist.append([1280, 9, 1240, 0, -3, 3, [(0,0)], [(100,1,0)],200])

            # 1500 ticks: vierde aanval: fighters (horizontaal naar rechts, aimed)
            self.spawnlist.append([1500, 9, 0, 200, 5, 0, [(0,0)], [(100,1,0)],200])
            self.spawnlist.append([1560, 9, 0, 200, 5, 0, [(0, 0)], [(100, 1, 0)], 0])
            self.spawnlist.append([1620, 9, 0, 200, 5, 0, [(0, 0)], [(100, 1, 0)], 200])
            self.spawnlist.append([1680, 9, 0, 200, 5, 0, [(0, 0)], [(100, 1, 0)], 0])

            # 1900 ticks: zesde aanval: fighters (move, shoot aimed, strafe)
            self.spawnlist.append([1900, 9, 420, 0, 0, 6, [(0,0),(40,2)], [(100,1,0)],200])
            self.spawnlist.append([2000, 9, 720, 0, 0, 6, [(0,0),(40,2)], [(100,1,0)],200])
            self.spawnlist.append([2100, 9, 1020, 0, 0, 6, [(0,0),(40,2)], [(100,1,0)],200])
            self.spawnlist.append([2200, 9, 420, 0, 0, 6, [(0,0),(40,2)], [(100,1,0)],200])
            self.spawnlist.append([2300, 9, 720, 0, 0, 6, [(0,0),(40,2)], [(100,1,0)],200])
            self.spawnlist.append([2400, 9, 1020, 0, 0, 6, [(0,0),(40,2)], [(100,1,0)],200])

            # 2600 ticks: zevende aanval fighters (move, stop, aimed shooting)
            self.spawnlist.append([2600, 9, 650, 0, 0, 2, [(0, 0), (40, 3, 0, 0), (0, 0), (0, 0, 0, 0)], [(60, 1, 0)], 200])
            self.spawnlist.append([2660, 9, 75, 0, 0, 2, [(0, 0), (40, 3, 0, 0), (0, 0), (0, 0, 0, 0)], [(60, 1, 0)], 200])
            self.spawnlist.append([2720, 9, 1350, 0, 0, 2, [(0, 0), (40, 3, 0, 0), (0, 0), (0, 0, 0, 0)], [(60, 1, 0)], 200])
            ...
            self.spawnlist.append([3600, 9, 100, 0, 0, 6, [(0,0),(40,2)], [(60,1,0)],0])
            self.spawnlist.append([3700, 9, 500, 0, 0, 6, [(0,0),(40,2)], [(60,1,0)],0])
            self.spawnlist.append([3850, 9, 650, 0, 0, 2, [(0, 0), (40, 3, 0, 0), (0, 0), (0, 0, 0, 0)], [(60, 1, 0)], 200])
            self.spawnlist.append([3850, 9, 800, 0, 0, 6, [(0, 0), (40, 2)], [(60, 1, 0)], 0])
            self.spawnlist.append([4000, 9, 75, 0, 0, 2, [(0, 0), (40, 3, 0, 0), (0, 0), (0, 0, 0, 0)], [(60, 1, 0)], 200])
            self.spawnlist.append([4000, 9, 250, 0, 0, 6, [(0, 0), (40, 2)], [(60, 1, 0)], 0])
            self.spawnlist.append([4150, 9, 1350, 0, 0, 2, [(0, 0), (40, 3, 0, 0), (0, 0), (0, 0, 0, 0)], [(60, 1, 0)], 200])
            self.spawnlist.append([4150, 9, 1000, 0, 0, 6, [(0, 0), (40, 2)], [(60, 1, 0)], 0])
