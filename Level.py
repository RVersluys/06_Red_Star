...
class Level:
    ...
    def level_2(self):
        ...
        self.spawnlist.append([6500, fighter, 200, 0, 0, 3, [(0, 0), (40, strafe)], [(50, 3, 0)], 0])
        self.spawnlist.append([6550, fighter, 800, 0, 0, 3, [(0, 0), (40, strafe)], [(50, 3, 0)], 0])
        self.spawnlist.append([6600, fighter, 1000, 0, 0, 3, [(0, 0), (40, strafe)], [(50, 3, 0)], 0])
        self.spawnlist.append([6650, vulture, 500, 0, 0, 2, [(0, 0), (50, strafe), ], [(100, 1, 0)], 0])
        self.spawnlist.append([6700, fighter, 400, 0, 0, 3, [(0, 0), (40, strafe)], [(50, 3, 0)], 0])
        self.spawnlist.append([6750, fighter, 700, 0, 0, 3, [(0, 0), (40, strafe)], [(50, 3, 0)], 0])
        self.spawnlist.append([6800, fighter, 1000, 0, 0, 3, [(0, 0), (40, strafe)], [(50, 3, 0)], 0])
        self.spawnlist.append([6850, vulture, 200, 0, 0, 2, [(0, 0), (50, strafe), ], [(100, 1, 0)], 0])
        self.spawnlist.append([6900, fighter, 400, 0, 0, 3, [(0, 0), (40, strafe)], [(50, 3, 0)],0])
        self.spawnlist.append([6950, fighter, 1000, 0, 0, 3, [(0, 0), (40, strafe)], [(50, 3, 0)], 0])
        self.spawnlist.append([7000, fighter, 700, 0, 0, 3, [(0, 0), (40, strafe)], [(50, 3, 0)], 0])
        self.spawnlist.append([7050, vulture, 1000, 0, 0, 2, [(0, 0), (50, strafe), ], [(100, 1, 0)], 0])
        self.spawnlist.append([7100, fighter, 200, 0, 0, 3, [(0, 0), (40, strafe)], [(50, 3, 0)], 0])
        ...
        self.spawnlist.append([9700, fighter, 1100, 0, 0, 2, [(0, 0), (0, 0)], [(50, forwardShot, 0)], 1])
        self.spawnlist.append([9750, fighter, 1150, 0, 0, 2, [(0, 0), (0, 0)], [(50, forwardShot, 0)], 1])
        self.spawnlist.append([9800, fighter, 1200, 0, 0, 2, [(0, 0), (0, 0)], [(50, forwardShot, 0)], 1])
        self.spawnlist.append([9850, fighter, 1250, 0, 0, 2, [(0, 0), (0, 0)], [(50, forwardShot, 0)], 1])
        self.spawnlist.append([9900, fighter, 1300, 0, 0, 2, [(0, 0), (0, 0)], [(50, forwardShot, 0)], 1])
        self.spawnlist.append([9950, fighter, 1250, 0, 0, 2, [(0, 0), (0, 0)], [(50, forwardShot, 0)], 1])
        self.spawnlist.append([10000, fighter, 1200, 0, 0, 2, [(0, 0), (0, 0)], [(50, forwardShot, 0)], 1])
        self.spawnlist.append([10050, fighter, 1150, 0, 0, 2, [(0, 0), (0, 0)], [(50, forwardShot, 0)], 1])
        self.spawnlist.append([10100, fighter, 1100, 0, 0, 2, [(0, 0), (0, 0)], [(50, forwardShot, 0)], 1])
        ...
        self.spawnlist.append([14400, fighter, -50, 200, 5, 0, [(0, straightLine), (30, changeDirection, 0, 1)], [(50, forwardShot, 0)], 0])
        self.spawnlist.append([14425, fighter, 1500, 170, -5, 0, [(0, straightLine), (30, changeDirection, 0, 1)], [(50, forwardShot, 0)],0])
        self.spawnlist.append([14450, fighter, -50, 200, 5, 0, [(0, straightLine), (60, changeDirection, 0, 1)], [(50, forwardShot, 0)], 0])
        self.spawnlist.append([14475, fighter, 1500, 170, -5, 0, [(0, straightLine), (60, changeDirection, 0, 1)], [(50, forwardShot, 0)],0])
        self.spawnlist.append([14500, fighter, 1500, 200, 5, 0, [(0, straightLine), (60, changeDirection, 0, 1)], [(50, forwardShot, 0)],0])
        self.spawnlist.append([14500, vulture, 1500, 50, -3, 0, [(0, straightLine), (120, changeDirection, 0, 1)], [(100, aimedShot, 0)],2])
        self.spawnlist.append([14525, fighter, 1500, 170, -5, 0, [(0, straightLine), (90, changeDirection, 0, 1)], [(50, forwardShot, 0)],0])
        ...
        self.spawnlist.append([14600, fighter, -50, 200, 5, 0, [(0, straightLine), (90, changeDirection, 0, 1)], [(50, forwardShot, 0)], 0])
        self.spawnlist.append([14700, fighter, 1500, 150, -8, 0, [(0, straightLine), (90, changeDirection, 0, 1)], [(50, forwardShot, 0)],0])
        ...
        self.spawnlist.append([14925, fighter, -50, 100, 5, 0, [(0, straightLine), (80, changeDirection, 0, 1)], [(50, forwardShot, 0)], 0])
        self.spawnlist.append([14950, fighter, -50, 200, 5, 0, [(0, straightLine), (100, changeDirection, 0, 1)], [(50, forwardShot, 0)], 0])
        self.spawnlist.append([15000, fighter, -50, 100, 5, 0, [(0, straightLine), (160, changeDirection, 0, 1)], [(50, forwardShot, 0)],0])
        ...
        self.spawnlist.append([15600, fighter, -50, 250, 6, 0, [(0, straightLine), (160, changeDirection, 0, 1)], [(50, forwardShot, 0)],0])
        self.spawnlist.append([15625, fighter, -50, 200, 6, 0, [(0, straightLine), (130, changeDirection, 0, 1)], [(50, forwardShot, 0)],0])
        self.spawnlist.append([15650, fighter, -50, 180, 6, 0, [(0, straightLine), (90, changeDirection, 0, 1)], [(50, forwardShot, 0)],0])
        ...
        self.spawnlist.append([16125, fighter, 100, 1180, 0, -8, [(0, straightLine), (80, changeDirection, 3, 0)], [(50, forwardShot, 0)],0])
        self.spawnlist.append([16150, fighter, 100, 1180, 0, -8, [(0, straightLine), (75, changeDirection, 3, 0)],[(50, forwardShot, 0)], 0])
        self.spawnlist.append([16175, fighter, 100, 1180, 0, -8, [(0, straightLine), (60, changeDirection, 3, 0)], [(50, forwardShot, 0)],0])
        self.spawnlist.append([16220, fighter, 100, 1180, 0, -8, [(0, straightLine), (85, changeDirection, 3, 0)], [(50, forwardShot, 0)],0])
        self.spawnlist.append([16280, fighter, 100, 1180, 0, -8, [(0, straightLine), (70, changeDirection, 3, 0)], [(50, forwardShot, 0)],0])
        self.spawnlist.append([16350, destroyer, -100, 350, 7, 0, [(0, straightLine), (150, changeDirection, 0, 1)], [(100, 4, 0, 4, 20)],4])
        self.spawnlist.append([16360, fighter, 100, 1180, 0, -8, [(0, straightLine), (80, changeDirection, 3, 0)], [(50, forwardShot, 0)],0])
        ...
        self.spawnlist.append([16700, fighter, warscreenwidth+50, 400, -3, -1, [(0, straightLine), (0,  0)], [(50, forwardShot, 0)],1])
        self.spawnlist.append([16750, fighter, warscreenwidth + 50, 425, -3, -1, [(0, straightLine), (0, 0)], [(50, forwardShot, 0)], 1])
        self.spawnlist.append([16800, fighter, warscreenwidth + 50, 460, -3, -1, [(0, straightLine), (0, 0)], [(50, forwardShot, 0)], 1])
        self.spawnlist.append([16850, fighter, warscreenwidth + 50, 500, -3, -1, [(0, straightLine), (0, 0)], [(50, forwardShot, 0)], 1])

        # dominators die de lancer te hulp schieten
        self.spawnlist.append([17200, dominator, -100, 0, 3, 3, [(0, 0), (0, 0)], [(80, machineGun, 0), (100, aimedShot, 1)], 5])
        self.spawnlist.append([17200, dominator, warscreenwidth+100, 0, -3, 3, [(0, 0), (0, 0)], [(80, machineGun, 0), (100, aimedShot, 1)], 5])
