...
class Level:
    ...
    def level_1(self):
        ...
        self.spawnlist.append([500, fighter, warscreenwidth, 200, -3, 0, [(0, straightLine)], [(100, forwardShot, 0)], 0])
        self.spawnlist.append([560, fighter, warscreenwidth, 200, -3, 0, [(0, straightLine)], [(100, forwardShot, 0)], 1])
        self.spawnlist.append([620, fighter, warscreenwidth, 200, -3, 0, [(0, straightLine)], [(100, forwardShot, 0)], 0])
        ...
        self.spawnlist.append([1120, fighter, 1200, 0, 0, 3, [(0, straightLine)], [(100, forwardShot, 0)], 1])
        ...
        self.spawnlist.append([2000, fighter, 0, 200, 3, 0, [(0, straightLine)], [(100, forwardShot, 0)], 1])
        ...
        self.spawnlist.append([3900, cruiser, 650, 0, 0, 1, [(0, straightLine), (250, zigzag)], [(100, machineGun, 0)], 6])
        ...
        self.spawnlist.append([6800, 10, 100, 0, 0, 1, [(0, 0), (250, 1)], [(100, 2, 0)], 6])
        ...
        self.spawnlist.append([8100, fighter, 1300, 0, 0, 2, [(0, 1), (0, 0)], [(100, 3, 0)], 0])
        self.spawnlist.append([8150, fighter, 25, 0, 0, 2, [(0, 1), (0, 0)], [(100, 3, 0)], 0])
        self.spawnlist.append([8190, fighter, 300, 0, 0, 2, [(0, 1), (0, 0)], [(100, 3, 0)], 1])
        self.spawnlist.append([8260, fighter, 0, 0, 0, 2, [(0, 1), (0, 0)], [(100, 3, 0)], 1])
        self.spawnlist.append([8300, fighter, 1150, 0, 0, 2, [(0, 1), (0, 0)], [(100, 3, 0)], 0])
        self.spawnlist.append([8400, fighter, 750, 0, 0, 2, [(0, 1), (0, 0)], [(100, 3, 0)], 0])
        ...
        self.spawnlist.append([10700, cruiser, 1100, 0, 0, 1, [(0, 0), (200, 1)], [(100, 2, 0)], 6])
        self.spawnlist.append([11200, cruiser, 100, 0, 0, 1, [(0, 0), (300, 1)], [(100, 2, 0)], 6])
        ...
        self.spawnlist.append([12500, fighter, 50, 0, 0, 2,[(0, 0), (40, 2)], [(100, 3, 0)], 0])
        self.spawnlist.append([12580, fighter, 800, 0, 0, 2, [(0, 0), (40, 2)], [(100, 3, 0)], 0])
        self.spawnlist.append([12660, fighter, 1020, 0, 0, 2, [(0, 0), (40, 2)], [(100, 3, 0)], 0])
        self.spawnlist.append([12740, fighter, 200, 0, 0, 2, [(0, 0), (40, 2)], [(100, 3, 0)], 0])
        self.spawnlist.append([12820, fighter, 720, 0, 0, 2, [(0, 0), (40, 2)], [(100, 3, 0)], 0])
        self.spawnlist.append([12900, fighter, 1020, 0, 0, 2, [(0, 0), (40, 2)], [(100, 3, 0)], 0])
        self.spawnlist.append([13000, vulture, 600, 0, 0, 1, [(0, 0)], [(100, 1, 0)], 2])
        self.spawnlist.append([13100, vulture, 300, 0, 0, 1, [(0, 0)], [(100, 1, 0)], 2])
        self.spawnlist.append([13200, vulture, 500, 0, 0, 1, [(0, 0)], [(100, 1, 0)], 2])
        self.spawnlist.append([13300, vulture, 200, 0, 0, 1, [(0, 0)], [(100, 1, 0)], 2])
        ...
        self.spawnlist.append([14900, marauder, 100, 0, 0, 3, [(0, 0), (40, 3, 0, 0), (100, 4), (178, 3, 0, -7)], [(100, 2, 0)], 0])
        self.spawnlist.append([15200, marauder, warscreenwidth / 2, 0, 0, 3, [(0, 0), (40, 3, 0, 0), (100, 4), (178, 3, 0, -7)], [(100, 2, 0)],5])
        self.spawnlist.append([15600, cruiser, 850, 0, 0, 1, [(0, 0), (0, 0)], [(100, 2, 0)], 6])
    ...
    def level_2(self):
        ...
        # Marauders
        self.spawnlist.append([2100, marauder, 100, 0, 0, 3, [(0, 0), (40, 3, 0, 0), (100, 4), (178, 3, 0, -7)], [(100, 2, 0)], 3])
        self.spawnlist.append([2200, marauder, 1340, 0, 0, 3, [(0, 0), (40, 3, 0, 0), (100, 4), (178, 3, 0, -7)], [(100, 2, 0)], 3])
        ...
        self.spawnlist.append([4110, fighter, 720, 0, 0, 2, [(0, 0), (40, 2)], [(100, 3, 0)], 1])
        self.spawnlist.append([4140, fighter, 1020, 0, 0, 2, [(0, 0), (40, 2)], [(100, 3, 0)], 1])
        self.spawnlist.append([4170, fighter, 420, 0, 0, 2, [(0, 0), (40, 2)], [(100, 3, 0)], 1])
        self.spawnlist.append([4200, fighter, 720, 0, 0, 2, [(0, 0), (40, 2)], [(100, 3, 0)], 1])
        self.spawnlist.append([4230, fighter, 1020, 0, 0, 2, [(0, 0), (40, 2)], [(100, 3, 0)], 1])
        self.spawnlist.append([4260, fighter, 420, 0, 0, 2, [(0, 0), (40, 2)], [(100, 3, 0)], 1])
        self.spawnlist.append([4290, fighter, 720, 0, 0, 2, [(0, 0), (40, 2)], [(100, 3, 0)], 1])
        self.spawnlist.append([4320, fighter, 1020, 0, 0, 2, [(0, 0), (40, 2)], [(100, 3, 0)], 1])
        self.spawnlist.append([4350, fighter, 420, 0, 0, 2, [(0, 0), (40, 2)], [(100, 3, 0)], 1])
        self.spawnlist.append([4380, fighter, 720, 0, 0, 2, [(0, 0), (40, 2)], [(100, 3, 0)], 1])
        self.spawnlist.append([4410, fighter, 1020, 0, 0, 2, [(0, 0), (40, 2)], [(100, 3, 0)], 1])
        self.spawnlist.append([4440, fighter, 420, 0, 0, 2, [(0, 0), (40, 2)], [(100, 3, 0)],1])
        self.spawnlist.append([4470, fighter, 720, 0, 0, 2, [(0, 0), (40, 2)], [(100, 3, 0)], 1])
        self.spawnlist.append([4500, fighter, 1020, 0, 0, 2, [(0, 0), (40, 2)], [(100, 3, 0)], 1])
        self.spawnlist.append([4530, fighter, 420, 0, 0, 2, [(0, 0), (40, 2)], [(100, 3, 0)], 1])
        self.spawnlist.append([4560, fighter, 720, 0, 0, 2, [(0, 0), (40, 2)], [(100, 3, 0)], 1])
        self.spawnlist.append([4590, fighter, 1020, 0, 0, 2, [(0, 0), (40, 2)], [(100, 3, 0)], 1])
        self.spawnlist.append([4620, fighter, 420, 0, 0, 2, [(0, 0), (40, 2)], [(100, 3, 0)], 1])
        self.spawnlist.append([4650, fighter, 720, 0, 0, 2, [(0, 0), (40, 2)], [(100, 3, 0)], 1])
        self.spawnlist.append([4680, fighter, 1020, 0, 0, 2, [(0, 0), (40, 2)], [(100, 3, 0)], 1])
        self.spawnlist.append([4710, fighter, 420, 0, 0, 2, [(0, 0), (40, 2)], [(100, 3, 0)], 1])
        self.spawnlist.append([4750, fighter, 720, 0, 0, 2, [(0, 0), (40, 2)], [(100, 3, 0)], 1])
        self.spawnlist.append([4780, fighter, 1020, 0, 0, 2, [(0, 0), (40, 2)], [(100, 3, 0)], 1])
        self.spawnlist.append([4810, fighter, 420, 0, 0, 2, [(0, 0), (40, 2)], [(100, 3, 0)],1])

        # cruisers zigzaggend
        self.spawnlist.append([5000, cruiser, 100, 0, 0, 1, [(0, 0), (200, 1)], [(100, 2, 0)], 6])
        self.spawnlist.append([5200, cruiser, 1100, 0, 0, 1, [(0, 0), (200, 1)], [(100, 2, 0)], 6])
        ...
        self.spawnlist.append([6500, fighter, 200, 0, 0, 2, [(0, 0), (40, strafe)], [(100, 3, 0)], 0])
        self.spawnlist.append([6550, fighter, 800, 0, 0, 2, [(0, 0), (40, strafe)], [(100, 3, 0)], 0])
        self.spawnlist.append([6600, fighter, 1000, 0, 0, 2, [(0, 0), (40, strafe)], [(100, 3, 0)], 0])
        self.spawnlist.append([6650, vulture, 500, 0, 0, 2, [(0, 0), (50, strafe), ], [(100, 1, 0)], 0])
        self.spawnlist.append([6700, fighter, 400, 0, 0, 2, [(0, 0), (40, strafe)], [(100, 3, 0)], 0])
        self.spawnlist.append([6750, fighter, 700, 0, 0, 2, [(0, 0), (40, strafe)], [(100, 3, 0)], 0])
        self.spawnlist.append([6800, fighter, 1000, 0, 0, 2, [(0, 0), (40, strafe)], [(100, 3, 0)], 0])
        self.spawnlist.append([6850, vulture, 200, 0, 0, 2, [(0, 0), (50, strafe), ], [(100, 1, 0)], 0])
        self.spawnlist.append([6900, fighter, 400, 0, 0, 2, [(0, 0), (40, strafe)], [(100, 3, 0)],0])
        self.spawnlist.append([6950, fighter, 1000, 0, 0, 2, [(0, 0), (40, strafe)], [(100, 3, 0)], 0])
        self.spawnlist.append([7000, fighter, 700, 0, 0, 2, [(0, 0), (40, strafe)], [(100, 3, 0)], 0])
        self.spawnlist.append([7050, vulture, 1000, 0, 0, 2, [(0, 0), (50, strafe), ], [(100, 1, 0)], 0])
        self.spawnlist.append([7100, fighter, 200, 0, 0, 2, [(0, 0), (40, strafe)], [(100, 3, 0)], 0])
        self.spawnlist.append([7150, fighter, 500, 0, 0, 2, [(0, 0), (40, strafe)], [(100, 3, 0)], 0])
        self.spawnlist.append([7200, fighter, 700, 0, 0, 2, [(0, 0), (40, strafe)], [(100, 3, 0)], 0])
        ...
        self.spawnlist.append([8000, vulture, 1000, 0, 0, 10, [(100, changeDirection, 0, -2)], [(100, 1, 0)], 0])
        self.spawnlist.append([8200, vulture, 200, 0, 0, 10, [(100, changeDirection, 0, -2)], [(100, 1, 0)], 0])
        self.spawnlist.append([8200, vulture, 1000, 0, 0, 10, [(100, changeDirection, 0, -2)], [(100, 1, 0)], 0])
        self.spawnlist.append([8400, vulture, 200, 0, 0, 10, [(100, changeDirection, 0, -2)], [(100, 1, 0)], 0])
        self.spawnlist.append([8400, vulture, 1000, 0, 0, 10, [(100, changeDirection, 0, -2)], [(100, 1, 0)], 0])
        ...
        # dominator
        # en fighters
        self.spawnlist.append([9400, dominator, 150, 0, 0, 2, [(0, 0), (100, zigzag)], [(80, machineGun, 0),(100,aimedShot,1)], 5])
        self.spawnlist.append([9700, fighter, 1100, 0, 0, 2, [(0, 0), (0, 0)], [(100, forwardShot, 0)], 1])
        self.spawnlist.append([9750, fighter, 1150, 0, 0, 2, [(0, 0), (0, 0)], [(100, forwardShot, 0)], 1])
        self.spawnlist.append([9800, fighter, 1200, 0, 0, 2, [(0, 0), (0, 0)], [(100, forwardShot, 0)], 1])
        self.spawnlist.append([9850, fighter, 1250, 0, 0, 2, [(0, 0), (0, 0)], [(100, forwardShot, 0)], 1])
        self.spawnlist.append([9900, fighter, 1300, 0, 0, 2, [(0, 0), (0, 0)], [(100, forwardShot, 0)], 1])
        self.spawnlist.append([9950, fighter, 1250, 0, 0, 2, [(0, 0), (0, 0)], [(100, forwardShot, 0)], 1])
        self.spawnlist.append([10000, fighter, 1200, 0, 0, 2, [(0, 0), (0, 0)], [(100, forwardShot, 0)], 1])
        self.spawnlist.append([10050, fighter, 1150, 0, 0, 2, [(0, 0), (0, 0)], [(100, forwardShot, 0)], 1])
        self.spawnlist.append([10100, fighter, 1100, 0, 0, 2, [(0, 0), (0, 0)], [(100, forwardShot, 0)], 1])
        self.spawnlist.append([10150, fighter, 1150, 0, 0, 2, [(0, 0), (100, strafe)], [(100, forwardShot, 0)], 1])
        self.spawnlist.append([10200, fighter, 1200, 0, 0, 2, [(0, 0), (90, strafe)], [(100, forwardShot, 0)], 1])
        self.spawnlist.append([10250, fighter, 1250, 0, 0, 2, [(0, 0), (80, strafe)], [(100, forwardShot, 0)], 1])

        # zware wave met dominators en vultures
        self.spawnlist.append([10500, vulture, 140, 0, 0, 1, [(0, 0), (50, strafe)], [(100, aimedShot, 0)], 0])
        self.spawnlist.append([10600, vulture, 220, 0, 0, 1, [(0, 0), (50, strafe)], [(100, aimedShot, 0)], 0])
        self.spawnlist.append([10700, vulture, 300, 0, 0, 1, [(0, 0), (50, strafe)], [(100, aimedShot, 0)], 0])
        self.spawnlist.append([10800, vulture, 380, 0, 0, 1, [(0, 0), (50, strafe)], [(100, aimedShot, 0)], 0])
        self.spawnlist.append([10800, dominator, 1100, 0, 0, 1, [(0, 0), (50, zigzag)], [(80, machineGun, 0),(100,aimedShot,1)], 5])
        self.spawnlist.append([10900, vulture, 460, 0, 0, 1, [(0, 0), (50, strafe)], [(100, aimedShot, 0)], 0])
        ...
        # legio vultures
        self.spawnlist.append([12300, vulture, 1600, 1000, -1, -1, [(0,0), (0,0)], [(100, aimedShot, 0)], 0])
        self.spawnlist.append([12350, vulture, -50, 1000, 1, -1, [(0, 0), (0, 0)], [(100, aimedShot, 0)], 0])
        self.spawnlist.append([12400, vulture, 1600, 1000, -1, -1, [(0, 0), (0, 0)], [(100, aimedShot, 0)], 0])
        self.spawnlist.append([12400, vulture, 1600, 800, -1, -1, [(0, 0), (0, 0)], [(100, aimedShot, 0)], 0])
        self.spawnlist.append([12450, vulture, -50, 1000, 1, -1, [(0, 0), (0, 0)], [(100, aimedShot, 0)], 0])
        self.spawnlist.append([12450, vulture, -50, 800, 1, -1, [(0, 0), (0, 0)], [(100, aimedShot, 0)], 0])
        self.spawnlist.append([12500, vulture, 1600, 1000, -1, -1, [(0, 0), (0, 0)], [(100, aimedShot, 0)], 0])
        self.spawnlist.append([12500, vulture, 1600, 800, -1, -1, [(0, 0), (0, 0)], [(100, aimedShot, 0)], 0])
        self.spawnlist.append([12550, vulture, -50, 1000, 1, -1, [(0, 0), (0, 0)], [(100, aimedShot, 0)], 0])
        self.spawnlist.append([12550, vulture, -50, 800, 1, -1, [(0, 0), (0, 0)], [(100, aimedShot, 0)], 0])

        # legio fighters
        # en een marauder
        self.spawnlist.append([12900, fighter, 1300, 0, 0, 2, [(0, 1), (0, 0)], [(100, forwardShot, 0)], 0])
        self.spawnlist.append([12950, fighter, 1300, 0, 0, 2, [(0, 1), (0, 0)], [(100, forwardShot, 0)], 0])
        self.spawnlist.append([12975, fighter, 1000, 0, 0, 2, [(0, 1), (0, 0)], [(100, forwardShot, 0)], 0])
        self.spawnlist.append([13000, fighter, 1300, 0, 0, 2, [(0, 1), (0, 0)], [(100, forwardShot, 0)], 0])
        self.spawnlist.append([13025, fighter, 1000, 0, 0, 2, [(0, 1), (0, 0)], [(100, forwardShot, 0)], 0])
        self.spawnlist.append([13050, fighter, 1300, 0, 0, 2, [(0, 1), (0, 0)], [(100, forwardShot, 0)], 0])
        self.spawnlist.append([13075, fighter, 1000, 0, 0, 2, [(0, 1), (0, 0)], [(100, forwardShot, 0)], 0])
        self.spawnlist.append([13100, fighter, 1300, 0, 0, 2, [(0, 1), (0, 0)], [(100, forwardShot, 0)], 0])
        self.spawnlist.append([13125, fighter, 1000, 0, 0, 2, [(0, 1), (0, 0)], [(100, forwardShot, 0)], 0])
        self.spawnlist.append([13150, fighter, 1300, 0, 0, 2, [(0, 1), (0, 0)], [(100, forwardShot, 0)], 0])
        self.spawnlist.append([13175, fighter, 1000, 0, 0, 2, [(0, 1), (0, 0)], [(100, forwardShot, 0)], 0])
        self.spawnlist.append([13200, fighter, 1300, 0, 0, 2, [(0, 1), (0, 0)], [(100, forwardShot, 0)], 0])
        self.spawnlist.append([13225, fighter, 1000, 0, 0, 2, [(0, 1), (0, 0)], [(100, forwardShot, 0)], 0])
        self.spawnlist.append([13250, fighter, 1300, 0, 0, 2, [(0, 1), (0, 0)], [(100, forwardShot, 0)], 0])
        self.spawnlist.append([13350, marauder, 350, 0, 0, 3, [(0, 0), (40, 3, 0, 0), (100, 4), (178, 3, 0, -7)], [(100, 2, 0)], 5])

        # korte zware wave met lancer en dominators
        self.spawnlist.append([13500, lancer, 1150, 0, 0, 1, [(0, 0), (100, strafe)],[((25, aimedShot, 100), 3, 1), ((60, 100, 99999), 4, 1, 4, 15)], 9])
        ...
        # "muur" van cruisers
        self.spawnlist.append([14000, cruiser, 500, 0, 0, 1, [(0, 0), (0, 0)], [(100, 2, 0)], 6])
        self.spawnlist.append([14000, cruiser, 800, 0, 0, 2, [(0, 0), (0, 0)], [(100, 2, 0)], 6])
        self.spawnlist.append([14000, cruiser, 1100, 0, 0, 1, [(0, 0), (0, 0)], [(100, 2, 0)], 6])

        # paniekende fighters en vultures en een 'loose formation'
        self.spawnlist.append([14400, fighter, -50, 200, 5, 0, [(0, straightLine), (30, changeDirection, 0, 1)], [(100, forwardShot, 0)], 0])
        self.spawnlist.append([14425, fighter, 1500, 170, -5, 0, [(0, straightLine), (30, changeDirection, 0, 1)], [(100, forwardShot, 0)],0])
        self.spawnlist.append([14450, fighter, -50, 200, 5, 0, [(0, straightLine), (60, changeDirection, 0, 1)], [(100, forwardShot, 0)], 0])
        self.spawnlist.append([14475, fighter, 1500, 170, -5, 0, [(0, straightLine), (60, changeDirection, 0, 1)], [(100, forwardShot, 0)],0])
        self.spawnlist.append([14500, fighter, 1500, 200, 5, 0, [(0, straightLine), (60, changeDirection, 0, 1)], [(100, forwardShot, 0)],0])
        self.spawnlist.append([14500, vulture, 1500, 50, -3, 0, [(0, straightLine), (120, changeDirection, 0, 1)], [(100, aimedShot, 0)],2])
        self.spawnlist.append([14525, fighter, 1500, 170, -5, 0, [(0, straightLine), (90, changeDirection, 0, 1)], [(100, forwardShot, 0)],0])
        self.spawnlist.append([14525, vulture, 1500, 50, -4, 0, [(0, straightLine), (200, changeDirection, 0, 1)], [(100, aimedShot, 0)],2])
        self.spawnlist.append([14525, fighter, -100, 1000, 8, -8, [(0, 0), (0, 0)], [(0, 0, 0)], 1])
        self.spawnlist.append([14525, fighter, -150, 1100, 8, -8, [(0, 0), (0, 0)], [(0, 0, 0)], 1])
        self.spawnlist.append([14540, fighter, -130, 1050, 8, -8, [(0, 0), (0, 0)], [(0, 0, 0)], 1])
        self.spawnlist.append([14600, fighter, -50, 200, 5, 0, [(0, straightLine), (90, changeDirection, 0, 1)], [(100, forwardShot, 0)], 0])
        self.spawnlist.append([14700, fighter, 1500, 150, -8, 0, [(0, straightLine), (90, changeDirection, 0, 1)], [(100, forwardShot, 0)],0])
        self.spawnlist.append([14750, vulture, -130, 1050, 6, -6, [(0, 0), (0, 0)], [(100, aimedShot, 0)], 2])
        self.spawnlist.append([14850, fighter, 1200, 1050, 0, -8, [(0, 0), (0, 0)], [(0, 0, 0)], 1])
        self.spawnlist.append([14900, vulture, 200, 0, 0, 2, [(100, strafe), (0, 0)], [(100, aimedShot, 0)], 2])
        self.spawnlist.append([14925, fighter, -50, 100, 5, 0, [(0, straightLine), (80, changeDirection, 0, 1)], [(100, forwardShot, 0)], 0])
        self.spawnlist.append([14950, fighter, -50, 200, 5, 0, [(0, straightLine), (100, changeDirection, 0, 1)], [(100, forwardShot, 0)], 0])
        self.spawnlist.append([15000, fighter, -50, 100, 5, 0, [(0, straightLine), (160, changeDirection, 0, 1)], [(100, forwardShot, 0)],0])
        self.spawnlist.append([15150, vulture, 1000, 0, 0, 1, [(0, straightLine), (200, strafe)], [(100, aimedShot, 0)], 2])
        self.spawnlist.append([15350, cruiser, -150, 1100, 2, -2, [(0, 0), (0, 0)], [(50, machineGun, 0)], 6])
        self.spawnlist.append([15600, fighter, -50, 250, 6, 0, [(0, straightLine), (160, changeDirection, 0, 1)], [(100, forwardShot, 0)],0])
        self.spawnlist.append([15625, fighter, -50, 200, 6, 0, [(0, straightLine), (130, changeDirection, 0, 1)], [(100, forwardShot, 0)],0])
        self.spawnlist.append([15650, fighter, -50, 180, 6, 0, [(0, straightLine), (90, changeDirection, 0, 1)], [(100, forwardShot, 0)],0])

        # verzameling schepen die je proberen te stoppen bij het Command Schip te komen
        self.spawnlist.append([16000, destroyer, -100, 200, 7, 0, [(0, straightLine), (80, changeDirection, 0, 1)],  [(100, 4, 0, 4, 20)], 4])
        self.spawnlist.append([16100, destroyer, -100, 300, 7, 0, [(0, straightLine), (110, changeDirection, 0, 1)], [(100, 4, 0, 4, 20)],4])
        self.spawnlist.append([16125, fighter, 100, 1180, 0, -8, [(0, straightLine), (80, changeDirection, 3, 0)], [(100, forwardShot, 0)],0])
        self.spawnlist.append([16150, fighter, 100, 1180, 0, -8, [(0, straightLine), (75, changeDirection, 3, 0)],[(100, forwardShot, 0)], 0])
        self.spawnlist.append([16175, fighter, 100, 1180, 0, -8, [(0, straightLine), (60, changeDirection, 3, 0)], [(100, forwardShot, 0)],0])
        self.spawnlist.append([16220, fighter, 100, 1180, 0, -8, [(0, straightLine), (85, changeDirection, 3, 0)], [(100, forwardShot, 0)],0])
        self.spawnlist.append([16280, fighter, 100, 1180, 0, -8, [(0, straightLine), (70, changeDirection, 3, 0)], [(100, forwardShot, 0)],0])
        self.spawnlist.append([16350, destroyer, -100, 350, 7, 0, [(0, straightLine), (150, changeDirection, 0, 1)], [(100, 4, 0, 4, 20)],4])
        self.spawnlist.append([16360, fighter, 100, 1180, 0, -8, [(0, straightLine), (80, changeDirection, 3, 0)], [(100, forwardShot, 0)],0])
        self.spawnlist.append([16660, lancer, 1000, 1300, 0, -1, [(0, straightLine), (300, zigzag)],[((25, aimedShot, 100), 3, 1), ((60, 100, 99999), 4, 1, 4, 15)], 9])
        self.spawnlist.append([16800, destroyer, 150, 1200, 0, -7, [(0, straightLine), (100, changeDirection, 2, 0)], [(100, 4, 0, 4, 20)],4])
        self.spawnlist.append([16700, fighter, warscreenwidth+50, 400, -3, -1, [(0, straightLine), (0,  0)], [(100, forwardShot, 0)],1])
        self.spawnlist.append([16750, fighter, warscreenwidth + 50, 425, -3, -1, [(0, straightLine), (0, 0)], [(100, forwardShot, 0)], 1])
        self.spawnlist.append([16800, fighter, warscreenwidth + 50, 460, -3, -1, [(0, straightLine), (0, 0)], [(100, forwardShot, 0)], 1])
        self.spawnlist.append([16850, fighter, warscreenwidth + 50, 500, -3, -1, [(0, straightLine), (0, 0)], [(100, forwardShot, 0)], 1])

        # dominators die de lancer te hulp schieten
        self.spawnlist.append([17200, dominator, -100, 0, 2, 2, [(0, 0), (0, 0)], [(80, machineGun, 0), (100, aimedShot, 1)], 5])
        self.spawnlist.append([17200, dominator, warscreenwidth+100, 0, -2, 2, [(0, 0), (0, 0)], [(80, machineGun, 0), (100, aimedShot, 1)], 5])

        # last line of defence voor de hoofdbaas: marauders
        self.spawnlist.append([17700, marauder, warscreenwidth/2-300, 0, 0, 4, [(0, 0), (40, 3, 0, 0), (100, 4), (178, 3, 0, -7)], [(100, 2, 0)], 5])
