...
class Unitstats:
    def __init__(self):
        self.hitpoints = [10,10,10,30,30,30,60,60,60,40,350,140,1500,400, 230, 80, 500,300,500,500,2000,500,500,500]
        self.gold = [0, 0, 0, 0, 0, 0, 0, 0, 0, 100, 800, 400, 2500, 800, 500, 200, 600, 600, 600, 600, 600,600,600,600]
        self.pointvalue = [50,50,50,100,100,100,200,200,200,400,1500,800,5000, 1600, 1000, 500,1800, 100, 100, 100,100,100,100,100]
        self.explosion = [4,4,4,7,7,7,[8,9,10],[8,9,10],[8,9,10],8,[11,9,10,8],10,[11,11,11,10,10,10],[10,11],11,9,[9,9,10,10], [9,9,9,9,9,9], 9, 9,[11,10,11,10,11,10],[9,10,11],[9,10,11],9]
