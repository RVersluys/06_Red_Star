...
class Unitstats:
    def __init__(self):
        ...
        self.hitpoints =  [10,  10,  10,  30,  30,  30,  60,  60,  60,  40,  350, 140, 1500, 400, 230, 80, 500, 600, 500, 50,  2000,500, 500, 500, 10,  10,  30,  50,  2000,  100, 300, 250, 400, 800, 500, 30,  3000]
        self.gold =       [0,   0,   0,   0,   0,   0,   0,   0,   0,   100, 800, 400, 2500, 800, 500, 200,600, 600, 600, 50,  600, 600, 600, 600, 10,  10,  50,  50,  2000,  10,  10,  10,  10,  10,  10,  10,  10]
        self.pointvalue = [50,  50,  50,  100, 100, 100, 200, 200, 200, 400, 1500,800, 5000, 1600,1000,500,1800,1000,100, 50,  100, 100, 100, 100, 50,  10,  50,  50,  2500,  100, 10,  10,  10,  10,  10,  10,  3000]
        self.explosion =  [4,4,4,7,7,7,[8,9,10],[8,9,10],[8,9,10],8,[11,9,10,8],10,[11,11,11,10,10,10],[10,11],11,9,[9,9,10,10], [9,9,9,9,9,9], 9, [5,5,5,5],[11,10,11,10,11,10],[9,10,11],[9,10,11],9,4,4,[3,3,3],[6,6,6,6,6],11, 4,4,4,4,4,4,4,4]
    ...
    def weaponfire(self, program):
        if program[1] == 1:  # aimed weapon
            ...
            if program[2] == -1:
                ...
                movex = -math.sin(math.radians(angle)) * speed
                move = (movex, movey)
            damage = Projectiles.images.projectiles[3][1]
